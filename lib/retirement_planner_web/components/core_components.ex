defmodule RetirementPlannerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RetirementPlannerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RetirementPlannerWeb.Gettext, "errors", msg, opts)
    end
  end
